...
const ArchivedComplaintsScreen = ({ route, navigation }) => {
    ...
    const fetchData = async (page) => {
      ...
      try {
        const response = await fetch(`https://complaint-pma.punjab.gov.pk/api/archivelist/total/${route.params.data[0]['cityIds']}?page=${page + 1}`);
...
const styles = StyleSheet.create({
  ...
  export default ArchivedComplaintsScreen;
