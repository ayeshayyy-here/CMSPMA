...
const Cccaction = ({navigation, route}) => {
            ...
            <View>
              ...
              <View style={styles.radioItem}>
                <RadioButton
                  value="Verified"
                  status={
                    formData.status === 'Verified' ? 'checked' : 'unchecked'
                  }
                  onPress={() => handleInputChange('status', 'Verified')}
                  color="#6495ED"
                />
                <Text style={styles.radioLabel}>Verified</Text>
              </View>
              <View style={styles.radioItem}>
                <RadioButton
                  value="Rejected"
                  status={
                    formData.status === 'Rejected' ? 'checked' : 'unchecked'
                  }
                  onPress={() => handleInputChange('status', 'Rejected')}
                  color="#6495ED"
                />
                <Text style={styles.radioLabel}>Rejected</Text>
              </View>
