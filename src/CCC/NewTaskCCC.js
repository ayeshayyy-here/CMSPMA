...
const NewTaskCCC = ({navigation,route}) => {
            ...
            <View
              style={[
                ...
                {justifyContent: 'space-between'},
                 ...
                 <TouchableOpacity onPress={() => navigation.navigate('FloatingButton')}>
      ...
      <TouchableWithoutFeedback>
        <Animatable.View
          ...
          <TouchableOpacity
            ...
            onPress={navigateToAssignedTask}>
...
const styles = StyleSheet.create({
  separator: {
    ...
    marginVertical: 5,  // Optional: Adjust spacing between the line and the buttons
  },
  swipebutton: {
    marginTop: '5%',
  },
  ...
  additionalText: {
    fontSize: 14,
    color: '#fff',
    marginLeft: '50%', // Pushes the text to the right
  },
  taskDescription: {
    marginTop: 10,
    backgroundColor: '#fff',
  ...
  optionsContainer: {
    ...
    elevation: 5,
    borderColor: '#ddd',
    opacity: 1,  // Ensure opacity is set to 1 for a fully opaque background
  },
