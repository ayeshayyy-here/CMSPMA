...
const Regcomplain = ({route, navigation}) => {
  ...
  useEffect(() => {
    fetch('https://complaint-pma.punjab.gov.pk/api/source')
      .then(response => response.json())
      .then(data => {
                    ...
                    <Text style={styles.innerlabelText}>{item.subcategory}</Text>
                          ...
                          <View style={styles.actionButtonContainer}>
                            <TouchableOpacity
                              ...
                              onPress={() =>
                                navigation.navigate('MiddleManViewDetails', {
        ...
        <View style={styles.headern}>
          <View style={styles.headerTextContainern}>
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              ...
              <Text style={styles.headerTextn}>CMS| MiddleMan</Text>
            </View>
