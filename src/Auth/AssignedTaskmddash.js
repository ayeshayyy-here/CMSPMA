...
const AssignedTaskmddash = ({navigation}) => {
...
const fetchData = async () => {
  ...
  try {
    ...
    // Log the total count of tasks
    // console.log('Total Tasks Count:', responseData.metadata.total);

    // Update total pages correctly
    const totalCount = responseData.metadata.total;
    setTotalPages(Math.ceil(totalCount / itemsPerPage)); // This should be correct

    // Set items based on fetched results
...
export default AssignedTaskmddash;
