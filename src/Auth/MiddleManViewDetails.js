...
const MiddleManViewDetails = ({ navigation, route }) => {
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          <View style={styles.headerTextContainer}>
            <Icon name="clipboard" size={18} color="#fff" style={styles.icon} />
        ...
        <View style={{ flex: 1, padding: '5%' }}>
          ...
          <View style={styles.textInputContainer}>
            <TextInput
              style={[styles.textInput]}
              value={currentComplaint.agent_name || 'N/A'}
              editable={false}
              multiline={true}
              numberOfLines={10}
            />
...
export default MiddleManViewDetails;
