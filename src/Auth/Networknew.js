...
const Networknew = ({navigation}) => {
  ...
  const fetchComplaints = async () => {
    ...
    try {
      ...
      // console.log('Chekc name', userName)
      const response = await fetch(
        `https://complaint-pma.punjab.gov.pk/api/notprocesscomp/${userName}/${offset}`,
      );
      ...
      // Initialize collapsed states array with false values
      const initialCollapsedStates = new Array(data.length).fill(true);
