...
const PFIAssignedTask = ({navigation}) => {
      ...
      <ScrollView contentContainerStyle={{flexGrow: 1}}>
        <View style={styles.content}>
          {loading ? (
            ...
            <Icon name="exclamation-circle" size={30} color="black" style={{ marginBottom: 10 }} />
            <Text style={{ color: 'black', textAlign: 'center' }}>No tasks available</Text>
          </View>
  ) : (
...
export default PFIAssignedTask;
